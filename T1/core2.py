...
#This File gives us the spearman correlation for week1 & week2 for 10 secs window
...
for file1 in os.listdir(path1):
    ...
    diff=[]
    rank1 =[]
    df1 = pd.read_excel(os.path.join('./W1T1',file1))
    ...
    for file2 in os.listdir(path2):
        ...
        n1.append(file1)
        n2.append(file2)
        df2 = pd.read_excel(os.path.join('./W2T1', file2))
        # Storing all Usage(Doctet/Duration) column values of a file in a list
        dataset2 = df2['Usage']
...
dest = 'C:/Users/Dhiren Raj/Downloads/Information Security _ Privacy Material/Spear Correlation/w1w2.xlsx'
