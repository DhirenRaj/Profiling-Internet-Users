...
#This File gives us the spearman correlation for week2 & week2 for 10 secs window
...
for file1 in os.listdir(path2):
    ...
    rank1 = df1['Usage'].rank(method='average')
...
dest = 'C:/Users/Dhiren Raj/Downloads/Information Security _ Privacy Material/Spear Correlation/w2w2.xlsx'
